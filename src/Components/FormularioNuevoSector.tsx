...
const FormularioNuevoSector = ({ isOpen, onClose, onConfirmar }: FormularioNuevaMesaProps) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-150 p-4">
            <div className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-xs animate-in fade-in zoom-in duration-200">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Agregar Nuevo Sector</h2>
                ...
                <div className=  "flex  gap-2 mt-6">
                    ...
                    <button 
                        ...
                        className="flex-1 py-3 bg-indigo-600 text-white font-bold hover:bg-indigo-700 rounded-xl transition-colors"
                        > Crear Sector</button>
                </div>
            </div>
        </div>
...
export default FormularioNuevoSector;
